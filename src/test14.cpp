        ...
        double rpm, std::vector<double> px, std::vector<double> py)
{
    ...
    // -------------------------
    int poly_n = 1.0; // quadratic root taper (change to 3 or 4 for stronger root decay)
...
int main()
{
    try {
        ...
        double disX = 0.08;        // x-offset of circle center (negative/positive shapes camber)
        double disY = 0.36;        // y-offset of circle center
        ...
        double alpha_root_deg = 28.0;
        double alpha_tip_deg = 24.0; 
