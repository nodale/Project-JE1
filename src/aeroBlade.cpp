// joukowsky_panel.cpp
// Build with: g++ -std=c++17 -O2 joukowsky_panel.cpp -o joukowsky_panel
...
int main()
{
    try {
        ...
        double disY = 0.01;        // y-offset of circle center
        double backFat = 1.02;     // 'backFat' scaling parameter used in generation
        double AoA_deg = 4.0;      // angle of attack in degrees
        double Vinf = 1.0;         // free-stream speed
